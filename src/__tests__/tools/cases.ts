...
export const messageCases: ToolCase[] = [
  ...
  },
  {
    ...
    args: { ...CHANNEL },
    path: "chat.getPinnedMessages",
    payload: { type: "messaging", id: "general", limit: 25 },
  },
  {
...
export const callCases: ToolCase[] = [
  ...
  },
  {
    ...
    payload: { type: "default", id: "standup", custom: { confetti: true }, user_id: "alice" },
  },
  {
...
export const participantCases: ToolCase[] = [
  ...
  },
  {
    ...
    payload: { type: "default", id: "standup", audio: true, user_ids: ["bob"] },
  },
  {
    tool: "video_mute_users",
    args: { ...CALL, mute_all_users: true, audio: false, video: true },
    path: "video.muteUsers",
    payload: { type: "default", id: "standup", audio: false, mute_all_users: true, video: true },
  },
  {
